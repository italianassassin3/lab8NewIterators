...
public class LinkedPositionalListCopy <E> implements PositionalList<E> {
	...
	public LinkedPositionalListCopy(PLIteratorMaker<Integer> make) {
		header = new DNode<>(); 
		trailer = new DNode<>(); 
		header.setNext(trailer);
		trailer.setPrev(header); 
	...
	private class BackwardsElementIterator implements Iterator<E> { 
		Iterator<Position<E>> posIterator = 
				new PositionalListElementsBackwardsIterator(); 
		@Override
		public boolean hasNext() {
			return posIterator.hasNext();
		}
	...
	private class PositionalListElementsBackwardsIterator implements Iterator<Position<E>> {
